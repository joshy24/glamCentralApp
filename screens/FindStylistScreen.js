...
class FindStylistScreen extends React.Component {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <View style={styles.container}>
        <Header
          ...
          centerComponent={{ text: 'FIND A STYLIST', style: { color: '#000' } }}
        />
        <Text style={{ padding: 20, textAlign: "center" }}>FIND Stylist</Text>
      </View>
    );
  }
}
...
export default FindStylistScreen;
